function [innr, k, sg, parameters] = parameters(testname)  
   parameters.N = 1;
    innr = 1.5;
...
%%     
       parameters.nStates = 4; %Original value is 2

    %%
%     parameters.nT = parameters.nStates*(100);%100--2 line of
%     data,200-4,400-8
    parameters.nT = parameters.nStates*500;
    %%
